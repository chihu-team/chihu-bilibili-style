...
export default StyleSheet.create({
  'page-collect-work ion-content': {
    'background': '#F4F4F4 !important'
  },
  'page-collect-work card_wrap': {
    'width': [{ 'unit': '%H', 'value': 1 }],
    'paddingTop': [{ 'unit': 'px', 'value': 12 }],
    'overflow': 'hidden'
  },
  'page-collect-work card_wrap card': {
  ...
  'page-collect-work card_wrap card bottom name': {
    'float': 'left'
  },
  'page-collect-work card_wrap card bottom time': {
    'float': 'right'
  }
});
