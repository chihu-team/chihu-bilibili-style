...
export default StyleSheet.create({
  'page-private-work ion-content': {
    'background': '#F4F4F4 !important'
  },
  'page-private-work card_wrap': {
    'width': [{ 'unit': '%H', 'value': 1 }],
    'paddingTop': [{ 'unit': 'px', 'value': 12 }],
    'overflow': 'hidden'
  },
  'page-private-work card_wrap card': {
  ...
  'page-private-work card_wrap card bottom name': {
    'float': 'left'
  },
  'page-private-work card_wrap card bottom time': {
    'float': 'right'
  }
});
